    ...
    <Box>
      ...
      >
        <List>
          ...
          <ListItemButton>
            <SearchIcon />{" "}
            <ListItemText primary="Search" style={{ textAlign: "center" }} />
          </ListItemButton>
          <ListItemButton>
            <LibraryAddIcon />{" "}
            <ListItemText primary="Library" style={{ textAlign: "center" }} />
          </ListItemButton>
        </List>
        ...
        <Box sx={{ width: "100%", overflow: "hidden", padding: "6%" }}>
          <Widget>
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <CoverImage>
                <img alt="can't win - Chilling Sunday" src="/images/RRR.png" />
              </CoverImage>
